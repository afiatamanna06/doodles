  ...
  return (
    <Flex position="relative" justify="center" alignItems="center" color="white" w="100%" minH="94vh">
        ...
        <Flex direction="column" alignItems="center" justify="space-between" h="70vh">
            ...
            <Button onClick={onOpen} border="2px" borderBottomWidth="4px" color="#6681c5" borderColor="#6681c5" px={8} py={6} borderRadius="xl">
            ...
            <Modal onClose={onClose} isOpen={isOpen} isCentered>
                ...
                <ModalContent height="30rem">
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/sv9TaQ5z9jw?playlist=sv9TaQ5z9jw&loop=1&autoplay=1&mute=1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" frameBorder="0" allowFullScreen>
                    </iframe>
                </ModalContent>
            </Modal>
        </Flex>
