...
function SignUpInput() {
  return (
    <Flex gap={[5, 5, 5, 3, 3]} direction={["column", "column", "column", "row", "row"]} alignItems={["start", "start", "start", "center", "center"]}>
        <Input minW={["17rem", "17rem", "22rem", "14rem", "14rem"]} color="black" type="email" bg="white" border="1px" borderColor="#D1B6B6" placeholder="Enter you email" _placeholder={{ color: "#D1B6B6" }} borderRadius="xl" size="sm" />
