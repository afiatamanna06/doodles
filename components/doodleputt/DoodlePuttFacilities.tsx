    ...
    >
      <Center>
        ...
        >
            ...
            <Flex direction={["column", "column", "row", "row", "row"]} justify="space-between" alignItems="center" gap={[6, 6, 6, 14]}>
                ...
                <Box>
                  <Box fontWeight="semibold" textAlign={["center", "center", "start", "start"]}>On-location livestream hosted by JuicyKatBae</Box>
                  <Box textAlign={["center", "center", "start", "start"]}>
                    JuicyKatBae is comprised of three OG Doodle holders who met on the Blockchain: Julia, Kat Sammy. Despite their geographical distance apart, the trio is united through their love of the Doodles community and fascination with all things Web3.
                  </Box>
                  <br />
                  <Box textAlign={["center", "center", "start", "start"]}>&quot;JKB&quot; hosts weekly Twitter Spaces, “JuicyKatBae Talk About Nothing” on Tuesdays at 8pm ET.</Box>
                </Box>
